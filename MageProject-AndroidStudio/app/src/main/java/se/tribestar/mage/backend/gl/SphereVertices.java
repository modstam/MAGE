 ...
 */
public class SphereVertices extends Vertices3{
    public static final int NUM_VERTICES = 24;
    public static final int NUM_INDICES = 42;


    public SphereVertices(GLGraphics glGraphics, int maxVertices, int maxIndices, boolean hasColor, boolean hasTexCoords, boolean hasNormals) {
